  ...
  =========================================================-->
    <main>        
      <section class="well well4">
            <div class="container" >
              <div class="row">
              <div class="col-xs-10 col-xs-offset-1" align="center" style="margin-top: 10px; margin-bottom: 30px; border: 1px solid; padding: 15px; background-color: LIGHTGREEN; border-radius: 15px; text-align: left">
<?php
  $cla=$_GET['clave'];
  ...
  while($lineaA=mysqli_fetch_array($registrosA)){
    ...
    echo"</div><form name=\"formComentario\" id=\"formComentario\" method=\"post\" action=\"inscomentarios.php?clave=$cla\">
      ...
      <textarea cols=\"50\" rows=\"3\" class=\"form-control\" name=\"comentario\" id=\"comentario\"></textarea><br>
      <div>
        <input type=\"submit\"  class=\"btn btn-primary center-block\" name=\"Añadir\" value=\"Añadir\">
      </div>
    </form>";
